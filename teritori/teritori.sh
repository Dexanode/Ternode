...
echo -e 'Cek Log: \e[1m\e[32mjournalctl -u teritorid -f -o cat\e[0m'
echo -e "Cek Teritorid node logs: \e[1m\e[32mcurl -s localhost:${TERITORI_PORT}657/status | jq .result.sync_info\e[0m"
