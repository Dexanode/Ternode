...
echo " ██   ██ ██       ██ ██  ██   ██ ██  ██ ██ ██    ██ ██   ██ ██      ";
echo " ██████  ███████ ██   ██ ██   ██ ██   ████  ██████  ██████  ███████ ";
echo "-*-* Automatic Installer for EmpowerChain | Chain ID : circulus-1 -*-*";
echo -e "\e[0m"
...
GENESIS=https://ss-t.empower.nodestake.top/genesis.json
ADDRBOOK=https://ss-t.empower.nodestake.top/addrbook.json
PORT=12
...
echo ""
echo -e "Check Binary Status	 : \033[1m\033[33msystemctl status $BINARY\033[0m"
echo -e "Check Logs		 : \033[1m\033m[33mjournalctl -fu $BINARY -o cat\033[0m"
echo -e "CHECK Sync Info	 : \033[1m\033m[33mcurl -s localhost:${PORT}57/status | jq .result.sync_info\033[0m"
echo -e "\033[0;33m-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*\033[0m"
