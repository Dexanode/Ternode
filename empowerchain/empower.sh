...
echo -e "Check Logs		 : \033[1m\33m[33mjournalctl -fu $BINARY -o cat\033[0m"
echo -e "CHECK Sync Info	 : \033[1m\33m[33mcurl -s localhost:${PORT}57/status | jq .result.sync_info\033[0m"
echo -e "\033[0;33m-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*\033[0m"
